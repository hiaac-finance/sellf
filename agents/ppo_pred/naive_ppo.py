...
from agents.simple_ppo.on_policy_algorithm import OnPolicyAlgorithm
#from agents.ppo.q_custom_utils import RollingAvg

from config import Config


class NaivePPO(OnPolicyAlgorithm):
    """
    ...
    def _setup_model(self) -> None:
        super(NaivePPO, self)._setup_model()
    ...
    def learn(
        ...
        # freze predictor model weights
        self.policy.predictor_net.eval()
