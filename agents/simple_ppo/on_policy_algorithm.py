...
from agents.simple_ppo.buffer import RolloutBuffer
...
class OnPolicyAlgorithm(BaseAlgorithm):
    ...
    def collect_rollouts(
        ...
        while n_steps < n_rollout_steps:
            ...
            rollout_buffer.add(self._last_obs, actions, y_obs, group, values, log_probs, rewards, self._last_episode_starts)
            # ----------------------------------------------------------------
